  ...
  <div class="main-swap-body modal-open">
    ...
    <div>
      <div class="page-title">
        ...
        <h2 
          class="page-title-second text-gray"
        >
          Access the most liquidity, lowest slippage and best exchange rates across
          Ethereum, BNB Chain, Polygon, Avalanche, Gnosis Chain, Optimistic Ethereum (OΞ)
          and Arbitrum.
        </h2>
      </div>
      ...
      <div class="grid-layout">
        <div class="right-col p-4">
          <MainMenu :trade-value="swapTrade" />
          <SwapFrom />
          <div 
              ...
              <div class="trade-charts-settings">
                ...
                <div class="chart-range-select-wrap">
                  ...
                  <div class="flex items-center text-xs">
                    <div
                      class="candle_chart-icon w-6 h-6 mr-2 hover:bg-black hover:cursor-pointer"
                    />
                    <div
                      class="line_chart-icon w-6 h-6 hover:bg-black hover:cursor-pointer"
                    />
                  </div>
                </div>
              </div>
